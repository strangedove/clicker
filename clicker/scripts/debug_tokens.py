...
from clicker.scripts.utils import DatasetConfig, DatasetMixtureConfig, resolve_config_inheritance
...
def debug_sample(
    ...
    # Add EOS for plain text (matching blend pipeline behavior)
